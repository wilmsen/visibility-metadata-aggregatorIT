...
public class ReceiveCompletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<ReceiveCompletedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ReceiveCompletedEvent>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this ReceiveCompletedEvent to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a ReceiveCompletedEvent from a ByteBuffer. */
  public static ReceiveCompletedEvent fromByteBuffer(
   ...
   */
  public ReceiveCompletedEvent(com.opentext.bn.converters.avro.entity.TransactionContext transactionContext, com.opentext.bn.converters.avro.entity.PayloadRef payloadRef, com.opentext.bn.converters.avro.entity.TransferInfo transferInfo, java.util.List<com.opentext.bn.converters.avro.entity.ProcessingStages> processingStages) {
  ...
  /**
   * Creates a new ReceiveCompletedEvent RecordBuilder.
   * @return A new ReceiveCompletedEvent RecordBuilder
   */
  public static com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder newBuilder() {
    return new com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder();
  }

  /**
   * Creates a new ReceiveCompletedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ReceiveCompletedEvent RecordBuilder
   */
  public static com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder newBuilder(com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder other) {
    return new com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder(other);
  }

  /**
   * Creates a new ReceiveCompletedEvent RecordBuilder by copying an existing ReceiveCompletedEvent instance.
   * @param other The existing instance to copy.
   * @return A new ReceiveCompletedEvent RecordBuilder
   */
  public static com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder newBuilder(com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent other) {
    return new com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder(other);
  }

  /**
   * RecordBuilder for ReceiveCompletedEvent instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ReceiveCompletedEvent>
    implements org.apache.avro.data.RecordBuilder<ReceiveCompletedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ReceiveCompletedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionContext)) {
        this.transactionContext = data().deepCopy(fields()[0].schema(), other.transactionContext);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder setTransactionContext(com.opentext.bn.converters.avro.entity.TransactionContext value) {
     ...
     * @return This builder.
     */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder setTransactionContextBuilder(com.opentext.bn.converters.avro.entity.TransactionContext.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder clearTransactionContext() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder setPayloadRef(com.opentext.bn.converters.avro.entity.PayloadRef value) {
     ...
     * @return This builder.
     */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder setPayloadRefBuilder(com.opentext.bn.converters.avro.entity.PayloadRef.Builder value) {
      clearPayloadRef();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder clearPayloadRef() {
      payloadRef = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder setTransferInfo(com.opentext.bn.converters.avro.entity.TransferInfo value) {
     ...
     * @return This builder.
     */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder setTransferInfoBuilder(com.opentext.bn.converters.avro.entity.TransferInfo.Builder value) {
      clearTransferInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder clearTransferInfo() {
      transferInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.ReceiveCompletedEvent.Builder setProcessingStages(java.util.List<com.opentext.bn.converters.avro.entity.ProcessingStages> value) {
    ...
    public ReceiveCompletedEvent build() {
      try {
        ReceiveCompletedEvent record = new ReceiveCompletedEvent();
        if (transactionContextBuilder != null) {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ReceiveCompletedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<ReceiveCompletedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ReceiveCompletedEvent>
    READER$ = (org.apache.avro.io.DatumReader<ReceiveCompletedEvent>)MODEL$.createDatumReader(SCHEMA$);

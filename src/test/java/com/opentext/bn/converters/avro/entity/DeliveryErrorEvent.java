...
public class DeliveryErrorEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<DeliveryErrorEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<DeliveryErrorEvent>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this DeliveryErrorEvent to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a DeliveryErrorEvent from a ByteBuffer. */
  public static DeliveryErrorEvent fromByteBuffer(
   ...
   */
  public DeliveryErrorEvent(com.opentext.bn.converters.avro.entity.TransactionContext transactionContext, com.opentext.bn.converters.avro.entity.ErrorInfo errorInfo, com.opentext.bn.converters.avro.entity.PayloadRef payloadRef, com.opentext.bn.converters.avro.entity.TransferInfo transferInfo, java.util.List<com.opentext.bn.converters.avro.entity.ProcessingStages> processingStages) {
  ...
  public java.lang.Object get(int field$) {
    ...
    case 3: return transferInfo;
    case 4: return processingStages;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: transferInfo = (com.opentext.bn.converters.avro.entity.TransferInfo)value$; break;
    case 4: processingStages = (java.util.List<com.opentext.bn.converters.avro.entity.ProcessingStages>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Creates a new DeliveryErrorEvent RecordBuilder.
   * @return A new DeliveryErrorEvent RecordBuilder
   */
  public static com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder newBuilder() {
    return new com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder();
  }

  /**
   * Creates a new DeliveryErrorEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new DeliveryErrorEvent RecordBuilder
   */
  public static com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder newBuilder(com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder other) {
    return new com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder(other);
  }

  /**
   * Creates a new DeliveryErrorEvent RecordBuilder by copying an existing DeliveryErrorEvent instance.
   * @param other The existing instance to copy.
   * @return A new DeliveryErrorEvent RecordBuilder
   */
  public static com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder newBuilder(com.opentext.bn.converters.avro.entity.DeliveryErrorEvent other) {
    return new com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder(other);
  }

  /**
   * RecordBuilder for DeliveryErrorEvent instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryErrorEvent>
    implements org.apache.avro.data.RecordBuilder<DeliveryErrorEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.transferInfo)) {
        this.transferInfo = data().deepCopy(fields()[3].schema(), other.transferInfo);
      ...
      if (isValidValue(fields()[4], other.processingStages)) {
        this.processingStages = data().deepCopy(fields()[4].schema(), other.processingStages);
        fieldSetFlags()[4] = true;
      }
    }

    /**
     * Creates a Builder by copying an existing DeliveryErrorEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(com.opentext.bn.converters.avro.entity.DeliveryErrorEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.transactionContext)) {
        this.transactionContext = data().deepCopy(fields()[0].schema(), other.transactionContext);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setTransactionContext(com.opentext.bn.converters.avro.entity.TransactionContext value) {
     ...
     * @return This builder.
     */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setTransactionContextBuilder(com.opentext.bn.converters.avro.entity.TransactionContext.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder clearTransactionContext() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setErrorInfo(com.opentext.bn.converters.avro.entity.ErrorInfo value) {
     ...
     * @return This builder.
     */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setErrorInfoBuilder(com.opentext.bn.converters.avro.entity.ErrorInfo.Builder value) {
      clearErrorInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder clearErrorInfo() {
      errorInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setPayloadRef(com.opentext.bn.converters.avro.entity.PayloadRef value) {
     ...
     * @return This builder.
     */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setPayloadRefBuilder(com.opentext.bn.converters.avro.entity.PayloadRef.Builder value) {
      clearPayloadRef();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder clearPayloadRef() {
      payloadRef = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setTransferInfo(com.opentext.bn.converters.avro.entity.TransferInfo value) {
     ...
     * @return This builder.
     */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setTransferInfoBuilder(com.opentext.bn.converters.avro.entity.TransferInfo.Builder value) {
      clearTransferInfo();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder clearTransferInfo() {
      transferInfo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder setProcessingStages(java.util.List<com.opentext.bn.converters.avro.entity.ProcessingStages> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.DeliveryErrorEvent.Builder clearProcessingStages() {
    ...
    public DeliveryErrorEvent build() {
      try {
        DeliveryErrorEvent record = new DeliveryErrorEvent();
        if (transactionContextBuilder != null) {
        ...
        if (transferInfoBuilder != null) {
          ...
          record.transferInfo = fieldSetFlags()[3] ? this.transferInfo : (com.opentext.bn.converters.avro.entity.TransferInfo) defaultValue(fields()[3]);
        }
        record.processingStages = fieldSetFlags()[4] ? this.processingStages : (java.util.List<com.opentext.bn.converters.avro.entity.ProcessingStages>) defaultValue(fields()[4]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<DeliveryErrorEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<DeliveryErrorEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DeliveryErrorEvent>
    READER$ = (org.apache.avro.io.DatumReader<DeliveryErrorEvent>)MODEL$.createDatumReader(SCHEMA$);
